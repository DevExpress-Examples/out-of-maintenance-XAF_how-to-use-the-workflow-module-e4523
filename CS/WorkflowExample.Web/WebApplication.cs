...
namespace WorkflowExample.Web {
    public partial class WorkflowExampleAspNetApplication : WebApplication {
        ...
        public WorkflowExampleAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void WorkflowExampleAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
#else
